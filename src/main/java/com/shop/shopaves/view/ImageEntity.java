...
public class ImageEntity extends MultiTouchEntity {
    ...
    public ImageEntity(int zIndex, Bitmap bitmap, Resources res)  {
        super(zIndex,res);
        mDrawable = getBitmapToDrawable(bitmap,res);
    }

    private Drawable getBitmapToDrawable(Bitmap bitmap, Resources res ){
